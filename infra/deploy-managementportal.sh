...
INFRA_DIR="$(cd "$(dirname "$0")/terraform/live/${ENVIRONMENT}/managementportal" && pwd)"
PACKAGE_PATH="${PACKAGE_PATH:-/tmp/forge-managementportal.zip}"
...
echo "Management portal package deployed to ${WEBAPP_NAME}."
